...
| 3 | Graphics features independent of Tiny3D | **in progress** — §7 (stages S0–S14; S0–S1 2026-09-25) | Vertex cache, Gouraud, sprite animation, CI4/TMEM residency, fonts, VI options, decals, skybox, sorted transparency — each with a BENCHMARKS row |
...
## 7. Phase 3 — Graphics features independent of Tiny3D — status: in progress (S0–S1 2026-09-25)
